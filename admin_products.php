...
if(isset($_POST['add_product'])){
   ...
   if($select_product->rowCount() > 0){
      ...
      if($image_size > 2000000){
         ...
         $insert_product = $conn->prepare("INSERT INTO `products`(name, price, stock, image, description) VALUES(?,?,?,?,?)");
         $insert_product->execute([$name, $price, $stock, $image, $description]);
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" required maxlength="1000" placeholder="enter product description" name="description">
