...
<header class="header">
   ...
   <section class="flex">
         ...
         <img src="images/breadbox_logo.png" alt width="60" height="50">
         <a href="#home" class="logo"><span>Bread</span>box.</a>
         <div class="apa"></div> 
         <div class="apa"></div> 
         <nav class="navbar">
            <a href="#home">Home</a>
...
<div class="shopping-cart">
   ...
   <section>
      ...
      <div class="cart-total"> grand total : <span>Rp<?= $grand_total; ?>,00</span></div>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/sourdough_home.png" alt="">
            </div>
            <div class="content">
               <h3>Sourdough</h3>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/loaf_home.png" alt="">
            </div>
            <div class="content">
               <h3>Loaf</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/garlicbread_home.png" alt="">
            </div>
            <div class="content">
               <h3>Garlic Bread</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/About us_baked with love.png" alt="">
         <h3>Baked with Love</h3>
         <p>Baked with love, enjoy happily.</p>
      </div>

      <div class="box">
         <img src="images/About us_fresh from the oven.png" alt="">
         <h3>Fresh from the Oven</h3>
         <p>Experience the magic of bread straight from our ovens.</p>
      </div>

      <div class="box">
         <img src="images/About us_delight.png" alt="">
         <h3>Delight in Every Bite</h3>
         <p>Discover a world of deliciousness in every single bite.</p>
      </div>
...
<section id="menu" class="menu">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <div class="price">Rp<?= $fetch_products['price'] ?>,00</div>
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="grand-total"> Grand total : <span>Rp<?= $grand_total; ?>,00</span></div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>cs@breadbox.com</p>
         <p>dysacorps@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Breadbox</span> | all rights reserved!
   </div>
